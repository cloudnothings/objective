...
type GeneratorCardType = {
  ...
  rawSchema: string | null // Store raw schema when generated by AI
  model: string
}
    ...
    <div className="h-screen bg-gray-50 dark:bg-black p-1 flex flex-col">
      ...
      <main className="grid grid-cols-1 lg:grid-cols-10 gap-1 flex-grow overflow-hidden">
        ...
        <div className="lg:col-span-4 space-y-1 overflow-y-auto custom-scrollbar pb-1 pr-0.5">
            ...
            <Card key={card.id}>
              <CardHeader className="p-2">
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-1.5 flex-grow">
                    ...
                    <Input
                      value={card.label}
                      onChange={(e) => handleGeneratorChange(card.id, "label", e.target.value)}
                  ...
                  <div className="flex gap-1">
                    <Button
                      variant="ghost"
                      size="icon"
                      onClick={() => setFullConfigDialog({ open: true, cardId: card.id })}
                    ...
                    <Button
                      ...
                      onClick={() => handleDeleteGeneratorCard(card.id)}
                    >
              ...
              <CardContent className="space-y-2 p-2 pt-0">
                <div>
                  ...
                  <Select value={card.model} onValueChange={(value) => handleGeneratorChange(card.id, "model", value)}>
                ...
                <div>
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <Button
                      variant="ghost"
                      size="icon"
                      onClick={() => setSystemMessageDialog({ open: true, cardId: card.id })}
                      className="h-6 w-6 text-xs"
                  ...
                  <Textarea
                    ...
                    onChange={(e) => handleGeneratorChange(card.id, "systemMessage", e.target.value)}
                    className="h-16 text-xs font-mono"
                  />
                </div>
                <div>
                  <div className="flex items-center justify-between mb-1">
                    <Label className="text-xs font-mono">schema</Label>
                    <div className="flex gap-1">
                      <Button
                        variant="ghost"
                        size="icon"
                        onClick={() => setSchemaDialog({ open: true, cardId: card.id })}
                        className="h-6 w-6 text-xs"
                        title="Generate with AI"
                      >
                        <Sparkles className="h-3 w-3" />
                      ...
                      <Button
                        variant="ghost"
                        size="icon"
                        onClick={() => handleImportSchema(card.id, setGeneratorCards, setImportError)}
                        className="h-6 w-6 text-xs"
                      ...
                      <Button
                        variant="ghost"
                        size="icon"
                        onClick={() => handleClearSchema(card.id)}
                        className="h-6 w-6 text-xs"
                        title="Clear schema"
                      >
                      ...
                      <Button
                        variant="ghost"
                        size="icon"
                        onClick={() => setEditingRawSchemaForCardId(card.id)}
                        className="h-6 w-6 text-xs"
                      ...
                      <Button
                        ...
                        size="icon"
                        onClick={() => {
                          // use the outer-scope `card` directly
                          if (card.rawSchema && !canParseSchema(card.rawSchema)) {
                            if (
                              ...
                              setEditingSchemaForCardId(card.id)
                            }
                          } else {
                            setEditingSchemaForCardId(card.id)
                          }
              ...
              <CardFooter className="p-2">
                <Button onClick={() => handleGenerate(card)} className="w-full h-7 text-xs font-mono">
                  generate
                </Button>
              </CardFooter>
            </Card>
          ...
          <Button
            variant="outline"
            onClick={handleAddGeneratorCard}
          ...
          {outputCards.map((card) => (
            <Card key={card.id}>
              ...
              <CardContent className="p-2 pt-0">
                ...
                {card.error && (
                  <div className="bg-red-50 dark:bg-red-900/20 text-red-700 dark:text-red-300 p-2 rounded text-xs font-mono">
        ...
        >
          <DialogContent className="max-w-3xl h-[90vh] flex flex-col">
            <DialogHeader className="p-3">
              ...
              <DialogDescription className="text-xs font-mono">edit zod schema code directly</DialogDescription>
            </DialogHeader>
            <div className="flex-grow overflow-y-auto p-3 custom-scrollbar">
              <SchemaEditor
